...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea_instr, mov_rm2s_w, inv,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_instr_imm16, ret_instr,
    /* 0xc4 - 0xc7*/ inv, inv, mov_i2rm_b, mov_i2rm_v,
    /* 0xc8 - 0xcb*/ inv, leave_instr, inv, inv,
    ...
    /* 0xe8 - 0xeb*/ call_instr, jmp_near, jmp_far_imm, jmp_short,
...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, inv, mul_rm2a_b, imul_rm2a_b, inv, idiv_rm2a_b};
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_instr_indirect, inv, jmp_near_indirect, inv, push_rm_v, inv};

instr_func group_7_entry[8] =
    {inv, inv, lgdt_instr, inv, inv, inv, inv, inv};
